<1>{
  ...
  rsq = 5950.5796,
  sd = <9>{ "25% chance to gain a Frenzy Charge on Kill with Main Hand", "25% chance to gain an Endurance Charge on Kill with Off Hand", "10% more Physical Damage while at maximum Frenzy Charges", "10% reduced Physical Damage taken while at maximum Endurance Charges" },
  size = 77.14,
  skill = 52575,
  sprites = {
