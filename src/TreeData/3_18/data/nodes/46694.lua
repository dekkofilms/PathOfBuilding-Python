<1>{
  ...
  id = 46694,
  in = { "56814", "43457" },
  linkedId = { 56814, 43457 },
  modKey = "[12 = Evasion|INC|-|-|-][{mod=[10 = BlindEffect|INC|-|-|-]} = EnemyModifier|LIST|-|-|-]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 0,
      name = "Evasion",
  ...
  rsq = 2830.24,
  sd = <9>{ "12% increased Evasion Rating", "10% increased Blind Effect" },
  size = 53.2,
  skill = 46694,
  sprites = {
