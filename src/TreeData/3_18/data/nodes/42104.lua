<1>{
  ...
  id = 42104,
  in = { "57080", "49621" },
  linkedId = { 57080, 49621 },
  modKey = "[4 = Speed|INC|Attack|-|-][10 = Accuracy|INC|-|-|type=Global]",
  modList = <3>{ <4>{
      flags = 1,
      keywordFlags = 0,
      name = "Speed",
  ...
  rsq = 2830.24,
  sd = <9>{ "4% increased Attack Speed", "10% increased Global Accuracy Rating" },
  size = 53.2,
  skill = 42104,
  sprites = {
