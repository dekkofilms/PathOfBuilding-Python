<1>{
  ...
  conquered = false,
  dn = "Mana Regeneration per Power Charge",
  g = 277,
  group = {
  ...
  id = 12888,
  in = { "44184" },
  linkedId = { 16954, 44184 },
  modKey = "[8 = ManaRegen|INC|-|-|type=Multiplier/var=PowerCharge]",
  modList = <3>{ <4>{ {
        type = "Multiplier",
        var = "PowerCharge"
      },
  ...
  rsq = 2830.24,
  sd = <8>{ "8% increased Mana Regeneration Rate per Power Charge" },
  size = 53.2,
  skill = 12888,
  sprites = {
