<1>{
  ...
  in = { "7092" },
  isNotable = true,
  linkedId = { 11016, 44298, 7092 },
  modKey = "[5 = PhysicalDamageGainAsLightning|BASE|-|-|-][5 = LightningPenetration|BASE|-|-|-]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 0,
  ...
  recipe = { "AmberOil", "AmberOil", "OpalescentOil" },
  rsq = 5950.5796,
  sd = <9>{ "Gain 5% of Physical Damage as Extra Lightning Damage", "Damage Penetrates 5% Lightning Resistance" },
  size = 77.14,
  skill = 14665,
  sprites = {
