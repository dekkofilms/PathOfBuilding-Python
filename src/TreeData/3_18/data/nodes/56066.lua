<1>{
  ...
  id = 56066,
  in = { "63447", "62217", "30926" },
  linkedId = { 63447, 62217, 30926 },
  modKey = "[12 = ElementalDamage|INC|Hit,Wand|-|-]",
  modList = <3>{ <4>{
      flags = 8388612,
      keywordFlags = 0,
  ...
  rsq = 2830.24,
  sd = <8>{ "12% increased Elemental Damage with Wands" },
  size = 53.2,
  skill = 56066,
  sprites = {
