<1>{
  ...
  conquered = false,
  dn = "Spell Block and Elemental Resistances",
  g = 106,
  group = {
  ...
  id = 62767,
  in = { "19919" },
  linkedId = { 63138, 19919 },
  modKey = "[4 = ElementalResist|BASE|-|-|-][3 = SpellBlockChance|BASE|-|-|type=Condition/varList={UsingStaff,UsingShield}]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 0,
  ...
  rsq = 2830.24,
  sd = <9>{ "+4% to all Elemental Resistances", "+3% chance to Block Spell Damage while holding a Staff or Shield" },
  size = 53.2,
  skill = 62767,
  sprites = {
