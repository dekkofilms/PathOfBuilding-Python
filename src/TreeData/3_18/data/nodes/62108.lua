<1>{
  ...
  conquered = false,
  dn = "Life Leech and Attack Speed",
  g = 96,
  group = {
  ...
  id = 62108,
  in = {},
  linkedId = { 28311, 40653 },
  modKey = "[3 = Speed|INC|Attack|-|-][0.4 = PhysicalDamageLifeLeech|BASE|Attack|-|-]",
  modList = <3>{ <4>{
      flags = 1,
      keywordFlags = 0,
      name = "Speed",
  ...
  rsq = 2830.24,
  sd = <9>{ "3% increased Attack Speed", "0.4% of Physical Attack Damage Leeched as Life" },
  size = 53.2,
  skill = 62108,
  sprites = {
