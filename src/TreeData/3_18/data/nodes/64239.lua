<1>{
  ...
  id = 64239,
  in = {},
  linkedId = { 22407, 64612, 41635 },
  modKey = "[12 = PhysicalDamage|INC|Hit,Wand|-|-][12 = Damage|INC|Ailment,Wand|-|-]",
  modList = <3>{ <4>{
      flags = 8388612,
      keywordFlags = 0,
      name = "PhysicalDamage",
  ...
  rsq = 2830.24,
  sd = <9>{ "12% increased Physical Damage with Wands", "Wand Attacks deal 12% increased Damage with Ailments" },
  size = 53.2,
  skill = 64239,
  sprites = {
