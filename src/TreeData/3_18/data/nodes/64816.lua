<1>{
  ...
  id = 64816,
  in = { "34959" },
  linkedId = { 27140, 43374, 34959 },
  modKey = "[12 = PhysicalDamage|INC|Fishing,Hit,Weapon2H,WeaponMelee|-|-][12 = Damage|INC|Ailment,Fishing,Weapon2H,WeaponMelee|-|-][0.4 = PhysicalDamageLifeLeech|BASE|Attack|-|-]",
  modList = <3>{ <4>{
      flags = 301989892,
      keywordFlags = 0,
      name = "PhysicalDamage",
  ...
  rsq = 2830.24,
  sd = <10>{ "12% increased Physical Damage with Two Handed Melee Weapons", "Attacks with Two Handed Melee Weapons deal 12% increased Damage with Ailments", "0.4% of Physical Attack Damage Leeched as Life" },
  size = 53.2,
  skill = 64816,
  sprites = {
