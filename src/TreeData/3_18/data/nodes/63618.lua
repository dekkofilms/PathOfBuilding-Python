<1>{
  ...
  skill = 63618,
  sprites = {
    normalActive = { 0.52139037433155, 0.090697674418605, 0.53877005347594, 0.12093023255814,
      handle = <userdata 1>,
      height = 26,
      width = 26
    },
    normalInactive = { 0.52139037433155, 0.090697674418605, 0.53877005347594, 0.12093023255814,
      handle = <userdata 2>,
      height = 26,
      width = 26
    }
