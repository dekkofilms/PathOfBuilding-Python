<1>{
  ...
  in = { "11659" },
  isNotable = true,
  linkedId = { 11128, 11659 },
  modKey = "[10 = ElementalResist|BASE|-|-|-][25 = AvoidInteruptStun|BASE|-|-|-][20 = Str|BASE|-|-|-][20 = Dex|BASE|-|-|-][20 = StrDex|BASE|-|-|-]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 0,
  ...
  recipe = { "ClearOil", "ClearOil", "VioletOil" },
  rsq = 5950.5796,
  sd = <12>{ "+10% to all Elemental Resistances", "25% chance to Avoid interruption from Stuns while Casting", "+20 to Strength and Dexterity" },
  size = 77.14,
  skill = 8135,
  sprites = {
