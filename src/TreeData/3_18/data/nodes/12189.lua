<1>{
  ...
  conquered = false,
  dn = "Cast Speed and Spell Critical Strike Chance",
  g = 401,
  group = {
  ...
  in = {},
  linkedId = { 5875, 37671 },
  modKey = "[3 = Speed|INC|Cast|-|-][10 = CritChance|INC|Spell|-|-]",
  modList = <3>{ <4>{
      flags = 16,
      keywordFlags = 0,
      name = "Speed",
  ...
  rsq = 2830.24,
  sd = <9>{ "3% increased Cast Speed", "10% increased Critical Strike Chance for Spells" },
  size = 53.2,
  skill = 12189,
  sprites = {
