<1>{
  ...
  conquered = false,
  dn = "Energy Shield and Mana Regeneration",
  g = 319,
  group = {
  ...
  id = 59650,
  in = {},
  linkedId = { 9650, 19374, 57226 },
  modKey = "[16 = EnergyShield|BASE|-|-|-][25 = ManaRegen|INC|-|-|-]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 0,
      name = "EnergyShield",
  ...
  rsq = 2830.24,
  sd = <9>{ "+16 to maximum Energy Shield", "25% increased Mana Regeneration Rate" },
  size = 53.2,
  skill = 59650,
  sprites = {
