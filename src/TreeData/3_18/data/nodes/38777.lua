<1>{
  ...
  id = 38777,
  in = { "2454" },
  linkedId = { 10282, 58449, 2454 },
  modKey = "[12 = Damage|INC|Ailment,Fishing,WeaponMelee|-|-][12 = PhysicalDamage|INC|Melee|-|-]",
  modList = <3>{ <4>{
      flags = 33556480,
      keywordFlags = 0,
      name = "Damage",
  ...
  rsq = 2830.24,
  sd = <9>{ "Attacks with Melee Weapons deal 12% increased Damage with Ailments", "12% increased Melee Physical Damage" },
  size = 53.2,
  skill = 38777,
  sprites = {
