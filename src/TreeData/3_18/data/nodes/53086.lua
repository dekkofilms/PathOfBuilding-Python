<1>{
  ...
  conquered = false,
  dn = "Projectile Damage, Mark Cast Speed",
  g = 644,
  group = {
    ascendancyName = "Deadeye",
  ...
  in = { "56856" },
  linkedId = { 5443, 56856 },
  modKey = "[10 = Damage|INC|Projectile|-|-][25 = Speed|INC|Cast|-|type=SkillType/skillType=109]",
  modList = <3>{ <4>{
      flags = 1024,
      keywordFlags = 0,
      name = "Damage",
  ...
  rsq = 2830.24,
  sd = <9>{ "10% increased Projectile Damage", "Mark Skills have 25% increased Cast Speed" },
  size = 53.2,
  skill = 53086,
  sprites = {
