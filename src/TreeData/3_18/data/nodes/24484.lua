<1>{
  ...
  rsq = 5950.5796,
  sd = <8>{ "10% increased Attack Speed if you've Hit with your Main Hand Weapon Recently", "10% increased Movement Speed if you've Hit with your Off Hand Weapon Recently" },
  size = 77.14,
  skill = 24484,
  sprites = {
