<1>{
  ...
  conquered = false,
  dn = "Physical Attack Damage",
  g = 308,
  group = {
    n = <2>{ "39211", "51856", "48513", "5612" },
    nodes = <table 2>,
    oo = {
      [2] = true
    },
  ...
  id = 5612,
  in = { "47389" },
  linkedId = { 39211, 35568, 47389 },
  modKey = "[12 = PhysicalDamage|INC|Attack|-|-]",
  modList = <3>{ <4>{
      flags = 1,
      keywordFlags = 0,
      name = "PhysicalDamage",
  ...
  rsq = 2830.24,
  sd = <8>{ "12% increased Attack Physical Damage" },
  size = 53.2,
  skill = 5612,
  sprites = {
