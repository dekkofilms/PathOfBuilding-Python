<1>{
  ...
  conquered = false,
  dn = "Critical Strike Chance and Multiplier",
  g = 639,
  group = {
    ascendancyName = "Assassin",
  ...
  id = 9014,
  in = { "58229" },
  linkedId = { 21264, 58229 },
  modKey = "[10 = CritMultiplier|BASE|-|-|-][15 = CritChance|INC|-|-|-]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 0,
      name = "CritMultiplier",
  ...
  rsq = 2830.24,
  sd = <9>{ "+10% to Critical Strike Multiplier", "15% increased Critical Strike Chance" },
  size = 53.2,
  skill = 9014,
  sprites = {
