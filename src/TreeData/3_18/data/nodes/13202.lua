<1>{
  ...
  conquered = false,
  dn = "Cold Damage and Cold Ailment Effect",
  g = 581,
  group = {
  ...
  id = 13202,
  in = { "17171" },
  linkedId = { 33196, 17171 },
  modKey = "[12 = ColdDamage|INC|-|-|-][10 = EnemyChillEffect|INC|-|-|-][10 = EnemyBrittleEffect|INC|-|-|-]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 0,
      name = "ColdDamage",
  ...
  rsq = 2830.24,
  sd = <10>{ "12% increased Cold Damage", "10% increased Effect of Cold Ailments" },
  size = 53.2,
  skill = 13202,
  sprites = {
