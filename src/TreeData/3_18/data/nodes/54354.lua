<1>{
  ...
  id = 54354,
  in = { "12412", "29856", "52213" },
  linkedId = { 12412, 29856, 52213 },
  modKey = "[12 = Damage|INC|Sword|Ailment,Hit|-]",
  modList = <3>{ <4>{
      flags = 4194304,
      keywordFlags = 786432,
      name = "Damage",
  ...
  rsq = 2830.24,
  sd = <8>{ "Sword Attacks deal 12% increased Damage with Hits and Ailments" },
  size = 53.2,
  skill = 54354,
  sprites = {
