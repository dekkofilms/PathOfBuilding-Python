<1>{
  ...
  conquered = false,
  dn = "Claw Ailment Damage and Poison Duration",
  g = 550,
  group = {
  ...
  in = { "19228" },
  linkedId = { 529, 19228 },
  modKey = "[15 = Damage|INC|Ailment,Claw|-|-][5 = EnemyPoisonDuration|INC|-|-|-]",
  modList = <3>{ <4>{
      flags = 264192,
      keywordFlags = 0,
      name = "Damage",
  ...
  rsq = 2830.24,
  sd = <9>{ "Claw Attacks deal 15% increased Damage with Ailments", "5% increased Poison Duration" },
  size = 53.2,
  skill = 36801,
  sprites = {
