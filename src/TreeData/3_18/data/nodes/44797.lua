<1>{
  ...
  conquered = false,
  dn = "Mana Regeneration, Arcane Surge Effect",
  g = 6,
  group = {
    ascendancyName = "Hierophant",
  ...
  id = 44797,
  in = { "30940" },
  linkedId = { 40510, 30940 },
  modKey = "[20 = ManaRegen|INC|-|-|-][10 = ArcaneSurgeEffect|INC|-|-|-]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 0,
      name = "ManaRegen",
  ...
  rsq = 2830.24,
  sd = <9>{ "20% increased Mana Regeneration Rate", "10% increased Effect of Arcane Surge on you" },
  size = 53.2,
  skill = 44797,
  sprites = {
