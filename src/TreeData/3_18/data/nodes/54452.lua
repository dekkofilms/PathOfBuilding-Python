<1>{
  ...
  conquered = false,
  dn = "Increased Energy Shield Leeched",
  g = 587,
  group = {
  ...
  id = 54452,
  in = { "25789" },
  linkedId = { 15852, 25789 },
  modKey = "[80 = EnergyShieldLeechRate|INC|-|-|-]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 0,
  ...
  rsq = 2830.24,
  sd = <8>{ "80% increased total Recovery per second from Energy Shield Leech" },
  size = 53.2,
  skill = 54452,
  sprites = {
