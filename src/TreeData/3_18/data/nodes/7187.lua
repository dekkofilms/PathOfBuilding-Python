<1>{
  ...
  conquered = false,
  dn = "Burning Damage Multiplier with Attacks",
  g = 402,
  group = {
  ...
  id = 7187,
  in = { "26365" },
  linkedId = { 36736, 26365 },
  modKey = "[6 = FireDotMultiplier|BASE|-|Attack|-]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 65536,
  ...
  rsq = 2830.24,
  sd = <8>{ "+6% to Fire Damage over Time Multiplier with Attack Skills" },
  size = 53.2,
  skill = 7187,
  sprites = {
