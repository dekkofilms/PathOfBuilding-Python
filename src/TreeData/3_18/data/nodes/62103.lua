<1>{
  ...
  conquered = false,
  dn = "Projectile Damage and Dexterity",
  g = 329,
  grantedDexterity = 5,
  group = {
  ...
  id = 62103,
  in = {},
  linkedId = { 58833, 39773, 60532 },
  modKey = "[10 = Damage|INC|Projectile|-|-][5 = Dex|BASE|-|-|-]",
  modList = <3>{ <4>{
      flags = 1024,
      keywordFlags = 0,
      name = "Damage",
  ...
  rsq = 2830.24,
  sd = <9>{ "10% increased Projectile Damage", "+5 to Dexterity" },
  size = 53.2,
  skill = 62103,
  sprites = {
