<1>{
  ...
  alternative = {},
  conquered = false,
  dn = "Chance to Suppress Spell Damage",
  ...
  rsq = 2830.24,
  sd = <7>{ "+2% chance to Suppress Spell Damage" },
  size = 53.2,
  skill = 45284,
  sprites = {
    normalActive = { 0.36497326203209, 0.030232558139535, 0.38235294117647, 0.06046511627907,
      handle = <userdata 1>,
      height = 26,
      width = 26
    },
    normalInactive = { 0.36497326203209, 0.030232558139535, 0.38235294117647, 0.06046511627907,
      handle = <userdata 2>,
      height = 26,
      width = 26
    }
