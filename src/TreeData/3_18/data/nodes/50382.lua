<1>{
  ...
  id = 50382,
  in = { "48093", "34560" },
  linkedId = { 49605, 48093, 34560 },
  modKey = "[4 = Speed|INC|Cast|-|type=Condition/var=DualWielding]",
  modList = <3>{ <4>{ {
        type = "Condition",
        var = "DualWielding"
      },
  ...
  rsq = 2830.24,
  sd = <8>{ "4% increased Cast Speed while Dual Wielding" },
  size = 53.2,
  skill = 50382,
  sprites = {
