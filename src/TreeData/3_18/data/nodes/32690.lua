<1>{
  ...
  conquered = false,
  dn = "Area of Effect per Endurance Charge",
  g = 332,
  group = {
  ...
  id = 32690,
  in = { "57011" },
  linkedId = { 64882, 57011 },
  modKey = "[3 = AreaOfEffect|INC|-|-|type=Multiplier/var=EnduranceCharge]",
  modList = <3>{ <4>{ {
        type = "Multiplier",
        var = "EnduranceCharge"
      },
  ...
  rsq = 2830.24,
  sd = <8>{ "3% increased Area of Effect per Endurance Charge" },
  size = 53.2,
  skill = 32690,
  sprites = {
