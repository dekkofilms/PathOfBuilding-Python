<1>{
  ...
  id = 8533,
  in = { "24914", "56381" },
  linkedId = { 11515, 24914, 56381 },
  modKey = "[14 = PhysicalDamage|INC|Fishing,Hit,Weapon2H,WeaponMelee|-|-][14 = Damage|INC|Ailment,Fishing,Weapon2H,WeaponMelee|-|-]",
  modList = <3>{ <4>{
      flags = 301989892,
      keywordFlags = 0,
      name = "PhysicalDamage",
  ...
  rsq = 2830.24,
  sd = <9>{ "14% increased Physical Damage with Two Handed Melee Weapons", "Attacks with Two Handed Melee Weapons deal 14% increased Damage with Ailments" },
  size = 53.2,
  skill = 8533,
  sprites = {
