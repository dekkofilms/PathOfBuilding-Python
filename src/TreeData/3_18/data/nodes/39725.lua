<1>{
  ...
  id = 39725,
  in = { "63357", "50986" },
  linkedId = { 63649, 24377, 63357, 50986 },
  modKey = "[6 = Speed|INC|Attack|-|-][25 = Accuracy|BASE|-|-|-]",
  modList = <3>{ <4>{
      flags = 1,
      keywordFlags = 0,
      name = "Speed",
  ...
  rsq = 2830.24,
  sd = <9>{ "6% increased Attack Speed", "+25 to Accuracy Rating" },
  size = 53.2,
  skill = 39725,
  sprites = {
