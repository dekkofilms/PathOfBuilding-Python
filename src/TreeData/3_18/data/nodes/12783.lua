<1>{
  ...
  conquered = false,
  dn = "Critical Strike Multiplier per Power Charge",
  g = 277,
  group = {
  ...
  in = { "16954" },
  linkedId = { 9261, 16954 },
  modKey = "[5 = CritMultiplier|BASE|-|-|type=Multiplier/var=PowerCharge]",
  modList = <3>{ <4>{ {
        type = "Multiplier",
        var = "PowerCharge"
      },
  ...
  rsq = 2830.24,
  sd = <8>{ "+5% to Critical Strike Multiplier per Power Charge" },
  size = 53.2,
  skill = 12783,
  sprites = {
