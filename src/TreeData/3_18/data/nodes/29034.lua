<1>{
  ...
  conquered = false,
  dn = "Two Handed Melee Damage and Stun Duration",
  g = 174,
  group = {
  ...
  in = { "8426" },
  linkedId = { 35436, 8426 },
  modKey = "[14 = PhysicalDamage|INC|Fishing,Hit,Weapon2H,WeaponMelee|-|-][14 = Damage|INC|Ailment,Fishing,Weapon2H,WeaponMelee|-|-][20 = EnemyStunDuration|INC|Fishing,Hit,Weapon2H,WeaponMelee|-|-]",
  modList = <3>{ <4>{
      flags = 301989892,
      keywordFlags = 0,
      name = "PhysicalDamage",
  ...
  rsq = 2830.24,
  sd = <10>{ "14% increased Physical Damage with Two Handed Melee Weapons", "Attacks with Two Handed Melee Weapons deal 14% increased Damage with Ailments", "20% increased Stun Duration with Two Handed Melee Weapons on Enemies" },
  size = 53.2,
  skill = 29034,
  sprites = {
