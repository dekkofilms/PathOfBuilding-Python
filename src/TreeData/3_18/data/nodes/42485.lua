<1>{
  ...
  conquered = false,
  dn = "Staff Spell Damage and Block",
  g = 310,
  group = {
  ...
  in = { "40075" },
  linkedId = { 7918, 40075 },
  modKey = "[10 = Damage|INC|Spell|-|type=Condition/var=UsingStaff][3 = BlockChance|BASE|-|-|type=Condition/var=UsingStaff]",
  modList = <3>{ <4>{ {
        type = "Condition",
        var = "UsingStaff"
      },
  ...
  rsq = 2830.24,
  sd = <9>{ "10% increased Spell Damage while wielding a Staff", "+3% Chance to Block Attack Damage while wielding a Staff" },
  size = 53.2,
  skill = 42485,
  sprites = {
