<1>{
  ...
  rsq = 5950.5796,
  sd = <9>{ "30% increased Attack Damage", "10% reduced Enemy Stun Threshold", "20% chance to double Stun Duration", "30% increased Damage with Ailments from Attack Skills" },
  size = 77.14,
  skill = 38790,
  sprites = {
