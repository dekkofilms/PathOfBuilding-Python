<1>{
  ...
  conquered = false,
  dn = "Brand Recall Cooldown Recovery",
  g = 250,
  group = {
  ...
  modKey = "[15 = CooldownRecovery|INC|-|-|type=SkillName/skillName=Brand Recall]",
  modList = <3>{ <4>{ {
  ...
  rsq = 2830.24,
  sd = <8>{ "Brand Recall has 15% increased Cooldown Recovery Rate" },
  size = 53.2,
  skill = 35035,
  sprites = {
