<1>{
  ...
  conquered = false,
  dn = "Minion Life and Physical Damage Reduction",
  g = 396,
  group = {
  ...
  modKey = "[{mod=[8 = Life|INC|-|-|-]} = MinionModifier|LIST|-|-|-][{mod=[8 = PhysicalDamageReduction|BASE|-|-|-]} = MinionModifier|LIST|-|-|-]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 0,
      name = "MinionModifier",
  ...
  rsq = 2830.24,
  sd = <9>{ "Minions have 8% increased maximum Life", "Minions have 8% additional Physical Damage Reduction" },
  size = 53.2,
  skill = 31103,
  sprites = {
