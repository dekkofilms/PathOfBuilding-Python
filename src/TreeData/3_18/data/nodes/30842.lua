<1>{
  ...
  id = 30842,
  in = { "43303" },
  linkedId = { 43412, 43303 },
  modKey = "[12 = Accuracy|INC|Fishing,Hit,Weapon2H,WeaponMelee|-|-]",
  modList = <3>{ <4>{
      flags = 301989892,
      keywordFlags = 0,
      name = "Accuracy",
  ...
  rsq = 2830.24,
  sd = <8>{ "12% increased Accuracy Rating with Two Handed Melee Weapons" },
  size = 53.2,
  skill = 30842,
  sprites = {
