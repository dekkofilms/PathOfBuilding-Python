<1>{
  ...
  conquered = false,
  dn = "Two Handed Melee Damage and Life Leech Speed",
  g = 235,
  group = {
  ...
  id = 6884,
  in = { "34959" },
  linkedId = { 27301, 34959 },
  modKey = "[12 = PhysicalDamage|INC|Fishing,Hit,Weapon2H,WeaponMelee|-|-][12 = Damage|INC|Ailment,Fishing,Weapon2H,WeaponMelee|-|-][60 = LifeLeechRate|INC|-|-|-]",
  modList = <3>{ <4>{
      flags = 301989892,
      keywordFlags = 0,
      name = "PhysicalDamage",
  ...
  rsq = 2830.24,
  sd = <10>{ "12% increased Physical Damage with Two Handed Melee Weapons", "Attacks with Two Handed Melee Weapons deal 12% increased Damage with Ailments", "60% increased total Recovery per second from Life Leech" },
  size = 53.2,
  skill = 6884,
  sprites = {
