<1>{
  ...
  id = 37887,
  in = { "63727" },
  linkedId = { 29359, 63727 },
  modKey = "[12 = Damage|INC|Attack|-|-][60 = LifeLeechRate|INC|-|-|-][12 = Damage|INC|Ailment|Attack|-]",
  modList = <3>{ <4>{
      flags = 1,
      keywordFlags = 0,
      name = "Damage",
  ...
  rsq = 2830.24,
  sd = <10>{ "12% increased Attack Damage", "60% increased total Recovery per second from Life Leech", "12% increased Damage with Ailments from Attack Skills" },
  size = 53.2,
  skill = 37887,
  sprites = {
