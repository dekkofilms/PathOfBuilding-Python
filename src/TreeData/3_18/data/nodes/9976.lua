<1>{
  ...
  in = { "6113" },
  linkedId = { 4940, 6113 },
  modKey = "[18 = PhysicalDamage|INC|Axe,Hit|-|-][18 = Damage|INC|Ailment,Axe|-|-]",
  modList = <3>{ <4>{
      flags = 65540,
      keywordFlags = 0,
      name = "PhysicalDamage",
  ...
  rsq = 2830.24,
  sd = <9>{ "18% increased Physical Damage with Axes", "Axe Attacks deal 18% increased Damage with Ailments" },
  size = 53.2,
  skill = 9976,
  sprites = {
