<1>{
  ...
  rsq = 5950.5796,
  sd = <8>{ "10% chance to gain a Power Charge when you Shock a Chilled Enemy", "25% increased Cold Damage with Hits against Shocked Enemies", "25% increased Lightning Damage with Hits against Chilled Enemies" },
  size = 77.14,
  skill = 37478,
  sprites = {
