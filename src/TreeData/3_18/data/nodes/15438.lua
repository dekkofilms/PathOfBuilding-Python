<1>{
  ...
  in = {},
  linkedId = { 49412, 8426 },
  modKey = "[10 = PhysicalDamage|INC|Fishing,Hit,Weapon2H,WeaponMelee|-|-][10 = Damage|INC|Ailment,Fishing,Weapon2H,WeaponMelee|-|-][10 = EnemyStunDuration|INC|Fishing,Hit,Weapon2H,WeaponMelee|-|-]",
  modList = <3>{ <4>{
      flags = 301989892,
      keywordFlags = 0,
      name = "PhysicalDamage",
  ...
  rsq = 2830.24,
  sd = <10>{ "10% increased Physical Damage with Two Handed Melee Weapons", "Attacks with Two Handed Melee Weapons deal 10% increased Damage with Ailments", "10% increased Stun Duration with Two Handed Melee Weapons on Enemies" },
  size = 53.2,
  skill = 15438,
  sprites = {
