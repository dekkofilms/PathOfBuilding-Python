<1>{
  ...
  recipe = { "VerdantOil", "TealOil", "TealOil" },
  rsq = 5950.5796,
  sd = <8>{ "20% increased maximum Mana", "Recover 2% of Mana on Kill" },
  size = 77.14,
  skill = 42804,
  sprites = {
