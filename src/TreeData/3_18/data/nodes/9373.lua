<1>{
  ...
  id = 9373,
  in = { "54142", "25178" },
  linkedId = { 54142, 25178 },
  modKey = "[8 = Mana|INC|-|-|-][5 = FlaskEffect|INC|-|-|-]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 0,
      name = "Mana",
  ...
  rsq = 2830.24,
  sd = <9>{ "8% increased maximum Mana", "Flasks applied to you have 5% increased Effect" },
  size = 53.2,
  skill = 9373,
  sprites = {
