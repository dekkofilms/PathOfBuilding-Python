<1>{
  ...
  rsq = 5950.5796,
  sd = <10>{ "Recover 3% of Life on Kill", "Recover 3% of Energy Shield on Kill", "Recover 3% of Mana on Kill", "50% increased Recovery Rate of Life, Mana and Energy Shield if you've Killed an Enemy affected by your Damage Over Time Recently" },
  size = 77.14,
  skill = 55867,
  sprites = {
