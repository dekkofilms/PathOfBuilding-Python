<1>{
  ...
  id = 19388,
  in = { "23852" },
  linkedId = { 52090, 23852 },
  modKey = "[10 = Damage|INC|Axe|Ailment,Hit|-][10 = Accuracy|INC|Axe,Hit|-|-]",
  modList = <3>{ <4>{
      flags = 65536,
      keywordFlags = 786432,
      name = "Damage",
  ...
  rsq = 2830.24,
  sd = <9>{ "Axe Attacks deal 10% increased Damage with Hits and Ailments", "10% increased Accuracy Rating with Axes" },
  size = 53.2,
  skill = 19388,
  sprites = {
