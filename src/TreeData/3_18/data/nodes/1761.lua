<1>{
  ...
  id = 1761,
  in = {},
  linkedId = { 41599, 36859 },
  modKey = "[15 = Damage|INC|Staff|Ailment,Hit|-][15 = Armour|INC|-|-|-]",
  modList = <3>{ <4>{
      flags = 2097152,
      keywordFlags = 786432,
      name = "Damage",
  ...
  rsq = 2830.24,
  sd = <9>{ "Staff Attacks deal 15% increased Damage with Hits and Ailments", "15% increased Armour" },
  size = 53.2,
  skill = 1761,
  sprites = {
