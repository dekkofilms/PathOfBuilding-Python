<1>{
  ...
  in = { "11811", "20127" },
  isNotable = true,
  linkedId = { 28903, 11811, 20127 },
  modKey = "[10 = DotMultiplier|BASE|-|MatchAll,Poison|-][10 = ChaosResist|BASE|-|-|-][30 = Damage|INC|-|Poison|-]",
  modList = <3>{ <4>{
      flags = 0,
  ...
  recipe = { "ClearOil", "VioletOil", "SilverOil" },
  rsq = 5950.5796,
  sd = <10>{ "+10% to Damage over Time Multiplier for Poison", "+10% to Chaos Resistance", "30% increased Damage with Poison" },
  size = 77.14,
  skill = 31359,
  sprites = {
