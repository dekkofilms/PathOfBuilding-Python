<1>{
  ...
  id = 7082,
  in = { "49415" },
  linkedId = { 4336, 5233, 49415 },
  modKey = "[14 = PhysicalDamage|INC|Hit,Sword|-|-][14 = Damage|INC|Ailment,Sword|-|-]",
  modList = <3>{ <4>{
      flags = 4194308,
      keywordFlags = 0,
      name = "PhysicalDamage",
  ...
  rsq = 2830.24,
  sd = <9>{ "14% increased Physical Damage with Swords", "Sword Attacks deal 14% increased Damage with Ailments" },
  size = 53.2,
  skill = 7082,
  sprites = {
