<1>{
  ...
  in = { "1696", "28330" },
  linkedId = { 1696, 28330 },
  modKey = "[4 = Speed|INC|Cast,Spell|Totem|-][5 = Speed|INC|Attack|Totem|-]",
  modList = <3>{ <4>{
      flags = 18,
      keywordFlags = 16384,
      name = "Speed",
  ...
  rsq = 2830.24,
  sd = <9>{ "Spells Cast by Totems have 4% increased Cast Speed", "Attacks used by Totems have 5% increased Attack Speed" },
  size = 53.2,
  skill = 25732,
  sprites = {
