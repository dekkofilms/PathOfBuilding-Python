<1>{
  ...
  id = 35507,
  in = { "37800" },
  linkedId = { 22356, 37800 },
  modKey = "[0.6 = PhysicalDamageLifeLeech|BASE|Attack|-|-][50 = LifeLeechRate|INC|-|-|-]",
  modList = <3>{ <4>{
      flags = 1,
      keywordFlags = 0,
  ...
  rsq = 2830.24,
  sd = <9>{ "0.6% of Physical Attack Damage Leeched as Life", "50% increased total Recovery per second from Life Leech" },
  size = 53.2,
  skill = 35507,
  sprites = {
