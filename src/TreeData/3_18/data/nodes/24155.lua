<1>{
  ...
  conquered = false,
  dn = "Mace Critical Strike Chance",
  g = 134,
  group = {
  ...
  id = 24155,
  in = { "10221" },
  linkedId = { 50225, 15086, 10221 },
  modKey = "[20 = CritChance|INC|Hit,Mace|-|-]",
  modList = <3>{ <4>{
      flags = 1048580,
      keywordFlags = 0,
      name = "CritChance",
  ...
  rsq = 2830.24,
  sd = <8>{ "20% increased Critical Strike Chance with Maces or Sceptres" },
  size = 53.2,
  skill = 24155,
  sprites = {
