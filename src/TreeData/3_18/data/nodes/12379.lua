<1>{
  ...
  conquered = false,
  dn = "Lightning Damage and Cast Speed",
  g = 251,
  group = {
  ...
  id = 12379,
  in = {},
  linkedId = { 44183, 14021 },
  modKey = "[8 = LightningDamage|INC|-|-|-][3 = Speed|INC|Cast|-|-]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 0,
  ...
  rsq = 2830.24,
  sd = <9>{ "8% increased Lightning Damage", "3% increased Cast Speed" },
  size = 53.2,
  skill = 12379,
  sprites = {
