<1>{
  ...
  conquered = false,
  dn = "Impale Effect with Two Handed Weapons",
  g = 66,
  group = {
  ...
  id = 864,
  in = { "61388" },
  linkedId = { 24858, 61388 },
  modKey = "[10 = ImpaleEffect|INC|Hit,Weapon2H|-|-]",
  modList = <3>{ <4>{
      flags = 268435460,
      keywordFlags = 0,
      name = "ImpaleEffect",
  ...
  rsq = 2830.24,
  sd = <8>{ "10% increased Effect of Impales you inflict with Two Handed Weapons" },
  size = 53.2,
  skill = 864,
  sprites = {
