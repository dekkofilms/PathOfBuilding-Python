<1>{
  ...
  id = 15716,
  in = { "45486" },
  linkedId = { 64395, 45486 },
  modKey = "[20 = CritChance|INC|Hit,Staff|-|-][12 = CritMultiplier|BASE|Hit,Staff|-|-]",
  modList = <3>{ <4>{
      flags = 2097156,
      keywordFlags = 0,
      name = "CritChance",
  ...
  rsq = 2830.24,
  sd = <9>{ "20% increased Critical Strike Chance with Staves", "+12% to Critical Strike Multiplier with Staves" },
  size = 53.2,
  skill = 15716,
  sprites = {
