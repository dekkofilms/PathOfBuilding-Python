<1>{
  ...
  isMastery = true,
  linkedId = { 13164, 44347, 14665 },
  masteryEffects = { {
      effect = 48385,
      stats = { "Exposure you inflict applies at least -18% to the affected Resistance" }
    }, {
      effect = 4119,
      stats = { "60% reduced Reflected Elemental Damage taken" }
    }, {
      effect = 59343,
      stats = { "Gain 10% of Physical Damage as Extra Damage of a random Element" }
    }, {
      effect = 17942,
      reminderText = { "(Ailments that do not deal Damage are Scorched, Chilled, Frozen, Brittle, Shocked, and Sapped)" },
      stats = { "40% increased Effect of Non-Damaging Ailments" }
    }, {
      effect = 30502,
      ...
      stats = { "1% of Elemental Damage Leeched as Energy Shield" }
    } },
  masterySprites = {
    activeEffectImage = {
      masteryActiveEffect = { 0.875, 0.28571428571429, 1, 0.42857142857143,
        handle = <userdata 1>,
        height = 185,
        width = 187
      }
    ...
    activeIcon = {
      masteryActiveSelected = { 0.34893048128342, 0.25, 0.40708556149733, 0.5,
        handle = <userdata 2>,
        height = 87,
        width = 87
      }
    ...
    inactiveIcon = {
      masteryConnected = { 0.34893048128342, 0.25, 0.40708556149733, 0.5,
        handle = <userdata 3>,
        height = 87,
        width = 87
      },
      masteryInactive = { 0.34893048128342, 0.25, 0.40708556149733, 0.5,
        handle = <userdata 4>,
        height = 87,
        width = 87
      }
