<1>{
  ...
  rsq = 5950.5796,
  sd = <8>{ "+5% Chance to Block Spell Damage while Dual Wielding", "Attack Skills deal 20% increased Damage while Dual Wielding", "20% chance to gain a Power Charge when you Block" },
  size = 77.14,
  skill = 24889,
  sprites = {
