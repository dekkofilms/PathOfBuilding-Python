<1>{
  ...
  angle = 0,
  conquered = false,
  dn = "Mana and Flask Charges Gained",
  g = 483,
  group = {
  ...
  id = 17421,
  in = { "51440" },
  linkedId = { 61306, 51440 },
  modKey = "[8 = Mana|INC|-|-|-][10 = FlaskChargesGained|INC|-|-|-]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 0,
      name = "Mana",
  ...
  rsq = 2830.24,
  sd = <9>{ "8% increased maximum Mana", "10% increased Flask Charges gained" },
  size = 53.2,
  skill = 17421,
  sprites = {
