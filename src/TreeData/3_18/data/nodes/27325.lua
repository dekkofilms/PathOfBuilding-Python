<1>{
  ...
  conquered = false,
  dn = "Damage against Marked Enemy",
  g = 460,
  group = {
  ...
  in = { "5237" },
  linkedId = { 8620, 5237 },
  modKey = "[20 = Damage|INC|-|Ailment,Hit|type=ActorCondition/actor=enemy/var=Marked]",
  modList = <3>{ <4>{ {
        actor = "enemy",
        type = "ActorCondition",
        var = "Marked"
  ...
  rsq = 2830.24,
  sd = <8>{ "20% increased Damage with Hits and Ailments against Marked Enemy" },
  size = 53.2,
  skill = 27325,
  sprites = {
