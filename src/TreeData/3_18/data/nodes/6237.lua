<1>{
  ...
  in = {},
  isNotable = true,
  linkedId = { 15599, 44529 },
  modKey = "[10 = Accuracy|INC|-|-|type=Global][6 = Speed|INC|-|-|-][20 = Dex|BASE|-|-|-]",
  modList = <3>{ <4>{ {
        type = "Global"
      },
      flags = 0,
  ...
  recipe = { "SepiaOil", "SepiaOil", "CrimsonOil" },
  rsq = 5950.5796,
  sd = <10>{ "10% increased Global Accuracy Rating", "6% increased Attack and Cast Speed", "+20 to Dexterity" },
  size = 77.14,
  skill = 6237,
  sprites = {
