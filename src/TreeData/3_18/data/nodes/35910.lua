<1>{
  ...
  conquered = false,
  dn = "Totem Life and Elemental Resistances",
  g = 69,
  group = {
  ...
  mods = { {
      ...
      extra = "Totems gain +16% to all Elemental Resistances "
    } },
  ...
  rsq = 2830.24,
  sd = <8>{ "15% increased Totem Life", "Totems gain +16% to all Elemental Resistances" },
  size = 53.2,
  skill = 35910,
  sprites = {
