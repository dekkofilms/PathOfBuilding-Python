<1>{
  ...
  in = { "33558" },
  isNotable = true,
  linkedId = { 4573, 41163, 33558 },
  modKey = "[30 = Evasion|INC|-|-|-][5 = MovementSpeed|INC|-|-|-][30 = CooldownRecovery|INC|-|Movement|-]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 0,
      name = "Evasion",
  ...
  recipe = { "SepiaOil", "AmberOil", "OpalescentOil" },
  rsq = 5950.5796,
  sd = <10>{ "30% increased Evasion Rating", "5% increased Movement Speed", "30% increased Cooldown Recovery Rate of Movement Skills" },
  size = 77.14,
  skill = 3309,
  sprites = {
