<1>{
  ...
  conquered = false,
  dn = "Evasion and Movement Skill Cooldown Recovery",
  g = 561,
  group = {
  ...
  in = { "9786", "3309" },
  linkedId = { 9786, 3309 },
  modKey = "[14 = Evasion|INC|-|-|-][15 = CooldownRecovery|INC|-|Movement|-]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 0,
      name = "Evasion",
  ...
  rsq = 2830.24,
  sd = <9>{ "14% increased Evasion Rating", "15% increased Cooldown Recovery Rate of Movement Skills" },
  size = 53.2,
  skill = 4573,
  sprites = {
