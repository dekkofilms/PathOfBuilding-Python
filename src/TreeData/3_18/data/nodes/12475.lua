<1>{
  ...
  conquered = false,
  dn = "Elemental Damage, Cold Ailment Effect",
  g = 312,
  group = {
    ascendancyName = "Elementalist",
  ...
  id = 12475,
  in = { "16023" },
  linkedId = { 40810, 16023 },
  modKey = "[10 = ElementalDamage|INC|-|-|-][10 = EnemyChillEffect|INC|-|-|-][10 = EnemyBrittleEffect|INC|-|-|-]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 0,
  ...
  rsq = 2830.24,
  sd = <10>{ "10% increased Elemental Damage", "10% increased Effect of Cold Ailments" },
  size = 53.2,
  skill = 12475,
  sprites = {
