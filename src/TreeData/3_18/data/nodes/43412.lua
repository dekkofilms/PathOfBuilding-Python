<1>{
  ...
  id = 43412,
  in = { "30842" },
  linkedId = { 34666, 34009, 30842 },
  modKey = "[12 = PhysicalDamage|INC|Fishing,Hit,Weapon2H,WeaponMelee|-|-][12 = Damage|INC|Ailment,Fishing,Weapon2H,WeaponMelee|-|-]",
  modList = <3>{ <4>{
      flags = 301989892,
      keywordFlags = 0,
      name = "PhysicalDamage",
  ...
  rsq = 2830.24,
  sd = <9>{ "12% increased Physical Damage with Two Handed Melee Weapons", "Attacks with Two Handed Melee Weapons deal 12% increased Damage with Ailments" },
  size = 53.2,
  skill = 43412,
  sprites = {
