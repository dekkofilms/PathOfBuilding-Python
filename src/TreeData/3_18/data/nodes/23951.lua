<1>{
  ...
  conquered = false,
  dn = "Movement Speed per Frenzy Charge",
  g = 332,
  group = {
  ...
  id = 23951,
  in = { "57449" },
  linkedId = { 16213, 57449 },
  modKey = "[2 = MovementSpeed|INC|-|-|type=Multiplier/var=FrenzyCharge]",
  modList = <3>{ <4>{ {
        type = "Multiplier",
        var = "FrenzyCharge"
      },
  ...
  rsq = 2830.24,
  sd = <8>{ "2% increased Movement Speed per Frenzy Charge" },
  size = 53.2,
  skill = 23951,
  sprites = {
