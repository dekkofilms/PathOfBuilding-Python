<1>{
  ...
  conquered = false,
  dn = "Energy Shield and Energy Shield Recharge Rate",
  g = 394,
  group = {
  ...
  id = 7641,
  in = { "49651" },
  linkedId = { 17236, 49651 },
  modKey = "[15 = EnergyShield|BASE|-|-|-][10 = EnergyShieldRecharge|INC|-|-|-]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 0,
      name = "EnergyShield",
  ...
  rsq = 2830.24,
  sd = <9>{ "+15 to maximum Energy Shield", "10% increased Energy Shield Recharge Rate" },
  size = 53.2,
  skill = 7641,
  sprites = {
