<1>{
  ...
  conquered = false,
  dn = "Mana and Arcane Surge Effect",
  g = 70,
  group = {
  ...
  id = 57167,
  in = { "22472" },
  linkedId = { 51108, 22472 },
  modKey = "[8 = Mana|INC|-|-|-][10 = ArcaneSurgeEffect|INC|-|-|-]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 0,
      name = "Mana",
  ...
  rsq = 2830.24,
  sd = <9>{ "8% increased maximum Mana", "10% increased Effect of Arcane Surge on you" },
  size = 53.2,
  skill = 57167,
  sprites = {
