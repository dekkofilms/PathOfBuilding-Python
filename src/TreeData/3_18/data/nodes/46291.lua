<1>{
  ...
  skill = 46291,
  sprites = {
    normalActive = { 0.15641711229947, 0.18139534883721, 0.17379679144385, 0.21162790697674,
      handle = <userdata 1>,
      height = 26,
      width = 26
    },
    normalInactive = { 0.15641711229947, 0.18139534883721, 0.17379679144385, 0.21162790697674,
      handle = <userdata 2>,
      height = 26,
      width = 26
    }
