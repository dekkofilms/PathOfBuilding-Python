<1>{
  ...
  id = 41599,
  in = { "15631", "1761" },
  linkedId = { 55926, 15631, 1761 },
  modKey = "[10 = Damage|INC|Staff|Ailment,Hit|-][2 = BlockChance|BASE|-|-|type=Condition/var=UsingStaff]",
  modList = <3>{ <4>{
      flags = 2097152,
      keywordFlags = 786432,
      name = "Damage",
  ...
  rsq = 2830.24,
  sd = <9>{ "Staff Attacks deal 10% increased Damage with Hits and Ailments", "+2% Chance to Block Attack Damage while wielding a Staff" },
  size = 53.2,
  skill = 41599,
  sprites = {
