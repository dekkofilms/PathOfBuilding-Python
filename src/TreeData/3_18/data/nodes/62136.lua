<1>{
  ...
  conquered = false,
  dn = "Projectile Damage, Mirage Archer Duration",
  g = 644,
  group = {
    ascendancyName = "Deadeye",
  ...
  in = { "2872" },
  linkedId = { 26067, 2872 },
  modKey = "[10 = Damage|INC|Projectile|-|-][15 = MirageArcherDuration|INC|-|-|-]",
  modList = <3>{ <4>{
      flags = 1024,
      keywordFlags = 0,
      name = "Damage",
  ...
  rsq = 2830.24,
  sd = <9>{ "10% increased Projectile Damage", "15% increased Mirage Archer Duration" },
  size = 53.2,
  skill = 62136,
  sprites = {
