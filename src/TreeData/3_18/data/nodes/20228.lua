<1>{
  ...
  id = 20228,
  in = { "54877", "39916", "17352" },
  linkedId = { 61525, 54877, 39916, 17352 },
  modKey = "[14 = Life|BASE|-|-|-][20 = ManaRegen|INC|-|-|-]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 0,
      name = "Life",
      ...
      flags = 0,
      keywordFlags = 0,
      name = "Condition:ConnectedToTemplarStart",
      source = "Tree:20228",
      type = "FLAG",
      value = true
    },
  ...
  rsq = 2830.24,
  sd = <9>{ "+14 to maximum Life", "20% increased Mana Regeneration Rate" },
  size = 53.2,
  skill = 20228,
  sprites = {
