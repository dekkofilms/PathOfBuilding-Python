<1>{
  ...
  in = { "2355" },
  linkedId = { 57900, 2355 },
  modKey = "[3 = BlockChance|BASE|-|-|type=Condition/varList={UsingShield}][10 = Damage|INC|Attack|-|type=Condition/varList={UsingShield}]",
  modList = <3>{ <4>{ {
        type = "Condition",
        varList = { "UsingShield" }
      },
  ...
  rsq = 2830.24,
  sd = <9>{ "+3% Chance to Block Attack Damage while holding a Shield", "10% increased Attack Damage while holding a Shield" },
  size = 53.2,
  skill = 53558,
  sprites = {
