<1>{
  ...
  conquered = false,
  dn = "Accuracy and Elemental Resistances",
  g = 431,
  group = {
  ...
  id = 43787,
  in = { "56589", "29379" },
  linkedId = { 56589, 29379 },
  modKey = "[10 = Accuracy|INC|-|-|type=Global][4 = ElementalResist|BASE|-|-|-]",
  modList = <3>{ <4>{ {
        type = "Global"
      },
      flags = 0,
  ...
  rsq = 2830.24,
  sd = <9>{ "10% increased Global Accuracy Rating", "+4% to all Elemental Resistances" },
  size = 53.2,
  skill = 43787,
  sprites = {
