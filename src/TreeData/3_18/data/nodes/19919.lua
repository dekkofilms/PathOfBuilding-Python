<1>{
  ...
  id = 19919,
  in = {},
  linkedId = { 55743, 62767, 6764 },
  modKey = "[3 = SpellBlockChance|BASE|-|-|type=Condition/varList={UsingStaff,UsingShield}]",
  modList = <3>{ <4>{ {
        type = "Condition",
  ...
  rsq = 2830.24,
  sd = <8>{ "+3% chance to Block Spell Damage while holding a Staff or Shield" },
  size = 53.2,
  skill = 19919,
  sprites = {
