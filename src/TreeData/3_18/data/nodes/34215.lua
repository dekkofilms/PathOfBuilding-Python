<1>{
  ...
  id = 34215,
  in = { "10143" },
  linkedId = { 34484, 10143 },
  modKey = "[10 = Damage|INC|Attack|-|-][0.4 = DamageLifeLeech|BASE|Attack|-|-]",
  modList = <3>{ <4>{
      flags = 1,
      keywordFlags = 0,
      name = "Damage",
  ...
  rsq = 2830.24,
  sd = <9>{ "10% increased Attack Damage", "0.4% of Attack Damage Leeched as Life" },
  size = 53.2,
  skill = 34215,
  sprites = {
    normalActive = { 0.72994652406417, 0.090697674418605, 0.74732620320856, 0.12093023255814,
      handle = <userdata 1>,
      height = 26,
      width = 26
    },
    normalInactive = { 0.72994652406417, 0.090697674418605, 0.74732620320856, 0.12093023255814,
      handle = <userdata 2>,
      height = 26,
      width = 26
    }
