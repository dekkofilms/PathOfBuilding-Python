<1>{
  ...
  id = 43061,
  in = { "12246" },
  linkedId = { 27323, 12246 },
  modKey = "[4 = SpellBlockChance|BASE|-|-|type=Condition/varList={UsingShield}]",
  modList = <3>{ <4>{ {
        type = "Condition",
        varList = { "UsingShield" }
      },
  ...
  rsq = 2830.24,
  sd = <8>{ "+4% Chance to Block Spell Damage while holding a Shield" },
  size = 53.2,
  skill = 43061,
  sprites = {
