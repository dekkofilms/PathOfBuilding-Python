<1>{
  ...
  conquered = false,
  dn = "Critical Strike Chance, Elusive Effect",
  g = 639,
  group = {
    ascendancyName = "Assassin",
  ...
  id = 43215,
  in = { "58229" },
  linkedId = { 28782, 58229 },
  modKey = "[10 = ElusiveEffect|INC|-|-|-][15 = CritChance|INC|-|-|-]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 0,
      name = "ElusiveEffect",
  ...
  rsq = 2830.24,
  sd = <9>{ "10% increased Elusive Effect", "15% increased Critical Strike Chance" },
  size = 53.2,
  skill = 43215,
  sprites = {
