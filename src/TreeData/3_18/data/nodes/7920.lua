<1>{
  ...
  conquered = false,
  dn = "Trap and Mine Throwing Speed",
  g = 530,
  group = {
  ...
  id = 7920,
  in = { "35283", "21575" },
  linkedId = { 46965, 35283, 21575 },
  modKey = "[4 = TrapThrowingSpeed|INC|-|-|-][4 = MineLayingSpeed|INC|-|-|-]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 0,
  ...
  rsq = 2830.24,
  sd = <9>{ "4% increased Trap Throwing Speed", "4% increased Mine Throwing Speed" },
  size = 53.2,
  skill = 7920,
  sprites = {
