<1>{
  ...
  rsq = 5950.5796,
  sd = <8>{ "Your Hexes can affect Hexproof Enemies", "Cursed Enemies you or your Minions Kill have a 40% chance to Explode, dealing a quarter of their maximum Life as Chaos Damage" },
  size = 77.14,
  skill = 37127,
  sprites = {
