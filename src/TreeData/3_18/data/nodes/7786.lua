<1>{
  ...
  conquered = false,
  dn = "Totem Damage and Attack Speed",
  g = 300,
  group = {
  ...
  in = { "55648" },
  linkedId = { 544, 55648 },
  modKey = "[10 = Damage|INC|-|Totem|-][4 = Speed|INC|Attack|Totem|-]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 16384,
      name = "Damage",
  ...
  rsq = 2830.24,
  sd = <9>{ "10% increased Totem Damage", "Attacks used by Totems have 4% increased Attack Speed" },
  size = 53.2,
  skill = 7786,
  sprites = {
