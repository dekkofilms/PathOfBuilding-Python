<1>{
  ...
  rsq = 5950.5796,
  sd = <8>{ "60% increased Main Hand Attack Damage while wielding two different Weapon Types", "30% increased Off Hand Attack Speed while wielding two different Weapon Types" },
  size = 77.14,
  skill = 39058,
  sprites = {
