<1>{
  ...
  in = { "55647" },
  isNotable = true,
  linkedId = { 58816, 55647 },
  modKey = "[30 = LightningDamage|INC|-|-|-][6 = LightningPenetration|BASE|-|-|-]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 0,
  ...
  recipe = { "SepiaOil", "AzureOil", "GoldenOil" },
  rsq = 5950.5796,
  sd = <9>{ "30% increased Lightning Damage", "Damage Penetrates 6% Lightning Resistance" },
  size = 77.14,
  skill = 56716,
  sprites = {
