<1>{
  ...
  skill = 60769,
  sprites = {
    normalActive = { 0.27807486631016, 0.06046511627907, 0.29545454545455, 0.090697674418605,
      handle = <userdata 1>,
      height = 26,
      width = 26
    },
    normalInactive = { 0.27807486631016, 0.06046511627907, 0.29545454545455, 0.090697674418605,
      handle = <userdata 2>,
      height = 26,
      width = 26
    }
