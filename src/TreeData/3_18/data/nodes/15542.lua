<1>{
  ...
  conquered = false,
  dn = "Attack and Cast Speed, Damage Over Time",
  g = 641,
  group = {
    ascendancyName = "Trickster",
  ...
  id = 15542,
  in = { "41891" },
  linkedId = { 55867, 41891 },
  modKey = "[10 = Damage|INC|Dot|-|-][4 = Speed|INC|-|-|-]",
  modList = <3>{ <4>{
      flags = 8,
      keywordFlags = 0,
      name = "Damage",
  ...
  rsq = 2830.24,
  sd = <9>{ "10% increased Damage over Time", "4% increased Attack and Cast Speed" },
  size = 53.2,
  skill = 15542,
  sprites = {
