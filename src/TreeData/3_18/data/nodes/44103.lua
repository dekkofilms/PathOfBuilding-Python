<1>{
  ...
  in = { "20812", "32091" },
  isNotable = true,
  linkedId = { 50757, 20812, 32091 },
  modKey = "[10 = SpellSuppressionChance|BASE|-|-|-][100 = Evasion|BASE|-|-|-][30 = Evasion|INC|-|-|-]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 0,
  ...
  recipe = { "AzureOil", "BlackOil", "GoldenOil" },
  reminderText = { "(50% of Damage from Suppressed Hits and Ailments they inflict is prevented)" },
  rsq = 5950.5796,
  sd = <10>{ "+10% chance to Suppress Spell Damage", "+100 to Evasion Rating", "30% increased Evasion Rating" },
  size = 77.14,
  skill = 44103,
  sprites = {
