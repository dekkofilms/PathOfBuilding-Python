<1>{
  ...
  in = { "58803" },
  isNotable = true,
  linkedId = { 39338, 58803 },
  modKey = "[45 = CritMultiplier|BASE|Fishing,Hit,Weapon2H,WeaponMelee|-|-]",
  modList = <3>{ <4>{
      flags = 301989892,
      keywordFlags = 0,
      name = "CritMultiplier",
  ...
  recipe = { "AmberOil", "VerdantOil", "OpalescentOil" },
  rsq = 5950.5796,
  sd = <8>{ "+45% to Critical Strike Multiplier with Two Handed Melee Weapons" },
  size = 77.14,
  skill = 32059,
  sprites = {
