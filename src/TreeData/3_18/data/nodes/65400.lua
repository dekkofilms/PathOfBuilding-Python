<1>{
  ...
  conquered = false,
  dn = "Warcry Cooldown Recovery and Exerted Attack Damage",
  g = 280,
  group = {
  ...
  modKey = "[12 = CooldownRecovery|INC|-|Warcry|-][15 = ExertIncrease|INC|Attack|-|-]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 4,
  ...
  rsq = 2830.24,
  sd = <9>{ "12% increased Warcry Cooldown Recovery Rate", "Exerted Attacks deal 15% increased Damage" },
  size = 53.2,
  skill = 65400,
  sprites = {
