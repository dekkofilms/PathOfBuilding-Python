<1>{
  ...
  rsq = 5950.5796,
  sd = <9>{ "40% chance to Poison on Hit", "5% increased Poison Duration for each Poison you have inflicted Recently, up to a maximum of 100%", "Recover 0.5% of Life per Poison affecting Enemies you Kill" },
  size = 77.14,
  skill = 1945,
  sprites = {
