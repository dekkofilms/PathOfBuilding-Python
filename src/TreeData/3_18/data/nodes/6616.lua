<1>{
  ...
  conquered = false,
  dn = "Dual Wield Cast Speed and Movement Skill Cooldown Recovery",
  g = 474,
  group = {
  ...
  id = 6616,
  in = { "44824" },
  linkedId = { 48093, 44824 },
  modKey = "[3 = Speed|INC|Cast|-|type=Condition/var=DualWielding][15 = CooldownRecovery|INC|-|Movement|-]",
  modList = <3>{ <4>{ {
        type = "Condition",
        var = "DualWielding"
      },
  ...
  rsq = 2830.24,
  sd = <9>{ "3% increased Cast Speed while Dual Wielding", "15% increased Cooldown Recovery Rate of Movement Skills" },
  size = 53.2,
  skill = 6616,
  sprites = {
