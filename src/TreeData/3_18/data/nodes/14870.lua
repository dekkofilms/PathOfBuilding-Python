<1>{
  ...
  conquered = false,
  dn = "Mana Regeneration, Totem Placement Speed",
  g = 6,
  group = {
    ascendancyName = "Hierophant",
  ...
  in = { "1105" },
  linkedId = { 34434, 1105 },
  modKey = "[20 = ManaRegen|INC|-|-|-][20 = TotemPlacementSpeed|INC|-|-|-]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 0,
      name = "ManaRegen",
  ...
  rsq = 2830.24,
  sd = <9>{ "20% increased Mana Regeneration Rate", "20% increased Totem Placement speed" },
  size = 53.2,
  skill = 14870,
  sprites = {
