<1>{
  ...
  conquered = false,
  dn = "Critical Strike Chance, Power Charge Duration",
  g = 639,
  group = {
    ascendancyName = "Assassin",
  ...
  in = { "4242" },
  linkedId = { 48239, 4242 },
  modKey = "[15 = PowerChargesDuration|INC|-|-|-][15 = CritChance|INC|-|-|-]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 0,
  ...
  rsq = 2830.24,
  sd = <9>{ "15% increased Power Charge Duration", "15% increased Critical Strike Chance" },
  size = 53.2,
  skill = 55686,
  sprites = {
