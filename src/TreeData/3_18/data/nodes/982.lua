<1>{
  ...
  conquered = false,
  dn = "Life Regeneration, Area of Effect",
  g = 7,
  group = {
    ascendancyName = "Chieftain",
  ...
  in = { "24704" },
  linkedId = { 5029, 24704 },
  modKey = "[10 = AreaOfEffect|INC|-|-|-][0.5 = LifeRegenPercent|BASE|-|-|-]",
  modList = <3>{ <4>{
      flags = 0,
      keywordFlags = 0,
      name = "AreaOfEffect",
  ...
  rsq = 2830.24,
  sd = <9>{ "10% increased Area of Effect", "Regenerate 0.5% of Life per second" },
  size = 53.2,
  skill = 982,
  sprites = {
