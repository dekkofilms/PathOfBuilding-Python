<1>{
  ...
  id = 36972,
  in = { "34666" },
  linkedId = { 43303, 34666 },
  modKey = "[4 = Speed|INC|Attack,Fishing,Hit,Weapon2H,WeaponMelee|-|-]",
  modList = <3>{ <4>{
      flags = 301989893,
      keywordFlags = 0,
      name = "Speed",
  ...
  rsq = 2830.24,
  sd = <8>{ "4% increased Attack Speed with Two Handed Melee Weapons" },
  size = 53.2,
  skill = 36972,
  sprites = {
